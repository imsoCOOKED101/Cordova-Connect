            ...
            <div className='border p-10 bg-[white] flex flex-col gap-5 text-center shadow-2xl rounded-xl text-gray-500 w-[450px]'>
                ...
                <form action="" className='flex flex-col gap-5'>
                  <div className='flex flex-col text-left gap-3'>
                    <label htmlFor="" className='font-semibold text-xs'>Student ID</label>
                    <input type="text" placeholder='2014-0123' className='border py-3 px-4 rounded-md'/>
                  </div>
                  <div className='flex flex-col text-left gap-3'>
                  ...
                  <button className='bg-[#EFF6FF] p-2 rounded-md'>Log in as Club Leader</button>
                  <button className='bg-[#EFF6FF] p-2 rounded-md'>Log in as Admin</button>
